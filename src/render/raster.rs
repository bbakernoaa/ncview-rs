...
pub fn rgb_raster_with_limits(
    ...
    let mapper =
        crate::render::colors::ColorMapper::new(&palette, stats, limits, ScaleMode::Linear, slice.is_diff);
...
fn rasterize(
    ...
    let mapper = crate::render::colors::ColorMapper::new(&palette, statistics, limits, scale, slice.is_diff);
